...
/*
  ...
  @parametros: ImagenesRedimensionadas: El objeto donde se almacenan las imagenes redimensionadas.
			   ...
			   anchoImagen: El ancho que tendrán las imagenes redimensionadas.

			   altoImagen: El alto que tendrán las imagenes redimensionadas.


  @details: NO modifica el objeto original donde se guardan las imágenes.
  ...
  @ejemplos de uso:
	...
	nuevasImagenes tendrá ahora las mismas imágenes y en el mismo orden
	que ListaImagenes, con la diferencia de que ahora seran de 100x100.


Pre: ImagenesRedimensionadas es un puntero válido.
...
{
    ImagenesRedimensionadas->Width = anchoImagen;
	ImagenesRedimensionadas->Height = altoImagen;
	...
	for (int i = 0; i < ListaImagenes->Count; i++) {
		...
		ImagenesRedimensionadas->Add(imagenRedimensionada, nullptr);
